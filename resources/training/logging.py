...
class SummarizationCallback(tf.keras.callbacks.Callback):
    def __init__(self, titleGenerator: GenerateSummary, texts_to_summarize, reference_titles):
        super().__init__()
    ...
    def on_epoch_end(self, epoch, logs=None):
        ...
        for input_text, generated_summary, reference_title in zip(
            ...
            rouge_score = compute_rouge(reference_title, generated_summary)
